...
public class AppModule {
    ...
    public SignatureKey signatureKey() {
         return new SignatureKey("75eb9080-3047-4475-ad5c-50ac2e883655 dart-test-srv 4031557782505020014 dart-test-srv".getBytes(Charsets.UTF_8));
    }
    ...
    public ConfigSupplier appConfigSupplier(ConfigLoader configLoader) {
        // Load settings.properties in com.walien.dart package as a set of config entries
        return configLoader.fromResource("com.walien.dart/settings");
    }
